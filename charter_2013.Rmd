...
* positive influence on the overall performance for 2013 seems to be whether the student doesn't skip school day for more than 30 consecutive days from when the school starts, the parent's education level, and the class size
