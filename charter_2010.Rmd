...
# 2010
#################
# schl2010_fit = lm(API10  ~ PEN_78 + PEN_911 + poly(PCT_AA, 2) + poly(PCT_AI, 2) + poly(PCT_AS, 3) + poly(PCT_WH, 1) + poly(P_GATE, 1) + P_MIGED + poly(AVG_ED, 4) + poly(MEALS, 1) ,
#                data = schl2010_trn)

schl2010_fit = lm(API10  ~  PEN_2  +  PEN_35   +  PEN_6   + PEN_78  +  PCT_AA  +  P_RFEP  +    P_DI   +   P_EL    + CBMOB + AVG_ED +  ENROLL, data = schl2010_trn)
...
#                data = schl2013_trn)
schl2013_fit = lm(API13  ~  PEN_2  +  PEN_35   +  PEN_6   + PEN_78  +  PCT_AA  +  P_RFEP  +    P_DI   +   P_EL    + CBMOB + AVG_ED +  ENROLL, data = schl2013_trn)
