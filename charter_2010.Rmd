...
We have decided to draw 700 random samples from the entire data set because smaller samples are easier to explain. We then split these samples in half, 350 for training and 350 for testing. With a population size of roughly 7000 valid data, sample size of 350 gives us about 95% confidence with 5% of error of accurately representing the model.
...
mod_2010 = lm(API10  ~ PEN_35 +  poly(PCT_AS, 2) +  PCT_AA  + PCT_WH + P_GATE +    P_EL  +   DMOB + PCT_RESP + P_MIGED + poly(AVG_ED, 3)  + BOTH, data = data_2010_trn )
...
# pred_2013 = predict(mod_2010, newdata = data_2013_tst)
# plot(pred_2013 ~ data_2013_tst$API13, col = "dodgerblue", xlab = "Actual 2013 API score", ylab = "Predicted 2013 API score")
# #abline(a = 0, b = 1, col = "darkorange", lwd = 3)
...
# pred_2004 = predict(mod_2010, newdata = data_2004_tst)
